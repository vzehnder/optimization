...
class Iter5RunProcess:
    ...
    def __call__(self, command, **kwargs):
        ...
        write_piecewise_hydro_outputs(output_dir)
            ...
            json.dumps(
                {
                    ...
                    "schema_version": "bess_system_dispatch.v2",
                    "hydro_generation_modes": {"hydro_pw_1": "piecewise_linear"},
...
def write_piecewise_hydro_outputs(output_dir):
    (output_dir / "dispatch.csv").write_text(
        ...
        "period_profit_usd\n"
        "2026-01-01T00:00:00,1.0,55.0,45.0,0.0,2.4,2.4,2.4,30.0,30.0,0.0,2.608,0.0,0.0,108.0\n"
        "2026-01-01T01:00:00,1.0,60.0,90.0,0.0,3.8,3.8,3.8,35.0,30.0,5.0,2.608,1.8,0.0,340.2\n",
        encoding="utf-8",
    )
    (output_dir / "asset_dispatch.csv").write_text(
        ...
        "2026-01-01T00:00:00,1.0,hydro_pw_1,hydro,2.4,30.0,30.0,0.0,0.108,0.108,0.0,2.608,713.04,0.0,0.0\n"
        "2026-01-01T01:00:00,1.0,hydro_pw_1,hydro,3.8,35.0,30.0,5.0,0.126,0.108,0.018,2.608,713.04,1.8,0.0\n",
        encoding="utf-8",
    )
