...
| BESS-HYDRO-DIAGRAM-001 | Create A Minimal Persisted Hydraulic Diagram Case | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-000 | [BESS-HYDRO-DIAGRAM-001-create-a-minimal-persisted-hydraulic-diagram-case.md](BESS-HYDRO-DIAGRAM-001-create-a-minimal-persisted-hydraulic-diagram-case.md) |
...
| BESS-HYDRO-DIAGRAM-006 | Run A Minimal v3 Hydraulic Network Case End To End | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-005 | [BESS-HYDRO-DIAGRAM-006-run-a-minimal-v3-hydraulic-network-case-end-to-end.md](BESS-HYDRO-DIAGRAM-006-run-a-minimal-v3-hydraulic-network-case-end-to-end.md) |
| BESS-HYDRO-DIAGRAM-007 | Bind Natural Inflow Series To Hydraulic Nodes | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-006 | [BESS-HYDRO-DIAGRAM-007-bind-natural-inflow-series-to-hydraulic-nodes.md](BESS-HYDRO-DIAGRAM-007-bind-natural-inflow-series-to-hydraulic-nodes.md) |
| BESS-HYDRO-DIAGRAM-008 | Add Reach Minimum Flow And Spillway Controls | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-007 | [BESS-HYDRO-DIAGRAM-008-add-reach-minimum-flow-and-spillway-controls.md](BESS-HYDRO-DIAGRAM-008-add-reach-minimum-flow-and-spillway-controls.md) |
| BESS-HYDRO-DIAGRAM-009 | Persist Layout And Snapshot Promoted Diagrams | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-006 | [BESS-HYDRO-DIAGRAM-009-persist-layout-and-snapshot-promoted-diagrams.md](BESS-HYDRO-DIAGRAM-009-persist-layout-and-snapshot-promoted-diagrams.md) |
| BESS-HYDRO-DIAGRAM-010 | Reject Unsupported Topologies And Stale Promotions | AFK | ready-for-agent | Todo | BESS-HYDRO-DIAGRAM-008, BESS-HYDRO-DIAGRAM-009 | [BESS-HYDRO-DIAGRAM-010-reject-unsupported-topologies-and-stale-promotions.md](BESS-HYDRO-DIAGRAM-010-reject-unsupported-topologies-and-stale-promotions.md) |
