...
| BESS-CONFIG-006 | Create And Activate An Operator Console End To End | AFK | ready-for-agent | In Review | BESS-CONFIG-002 | [BESS-CONFIG-006-create-and-activate-an-operator-console-end-to-end.md](BESS-CONFIG-006-create-and-activate-an-operator-console-end-to-end.md) |
