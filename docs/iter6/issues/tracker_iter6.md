...
| BESS-ITER6-008 | Finalize Iteration 6 Acceptance Suite And Docs | AFK | ready-for-agent | Done | BESS-ITER6-001 through BESS-ITER6-007 | [BESS-ITER6-008-finalize-iteration-6-acceptance-suite-and-docs.md](BESS-ITER6-008-finalize-iteration-6-acceptance-suite-and-docs.md) |
...
| 2026-06-12 | BESS-ITER6-008 | Todo -> Done | Added final Iteration 6 acceptance coverage for bootstrap auth, admin users, project assignment, manual run regression, dashboard templates, publication preview/publish/unpublish, client portal review, allowlisted downloads, internal-route denial, assignment revocation, deactivated-user denial, and closing README/manual docs. |
